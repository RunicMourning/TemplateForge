...
// Retrieve the 'p' parameter from the URL; default to 'dashboard' if not provided.
...
// Include the main admin template, which will use $pageTitle and display $pageContent.
include __DIR__ . '/templates/admin_template.php';
